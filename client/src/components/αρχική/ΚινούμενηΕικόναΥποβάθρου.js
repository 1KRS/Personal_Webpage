...
const BackgroundAnimation = () => {
  ...
  const εικόναΤομέα = πληροφορίεςΤομέα.εικόνα[ευρετήριοΌρου];
  const εικόναRef = useRef();
  return (
    <Περιέκτης>
      {τομέαςΑρχικής === 'ηρώο' ? (
        <svg
...
{
  /* <img src={εικόναΤομέα} alt="GIF" width="350" height="350" /> */
}
