...
const ΔιαχωριστήςΤομέα = styled.div`
  ...
  background: ${(props) =>
    props.αριστερά
      ? 'linear-gradient(90deg, #13ADC7 0%, #945DD6 50%, #945DD6 100%)'
      : (props) =>
          props.κέντρο
            ? 'linear-gradient(90deg, #945DD6 0%, #13ADC7 45%, #13ADC7 55%, #945DD6 100%)'
            : (props) =>
                props.δεξιά
                  ? 'linear-gradient(90deg, #945DD6 0%, #945DD6 50%, #13ADC7 100%)'
                  : 'linear-gradient(90deg, #945DD6 0%, #13ADC7 50%, #945DD6 100%)'};
  margin: ${(props) => (props.διαχωριστής ? '4rem 0 3rem' : '3rem 0 4rem')};
`;

export default ΔιαχωριστήςΤομέαΠάνω;
